...
<style>
body{
	background-image:linear-gradient(rgba(00,0,0,0.7),rgba(0,0,0,0.7)),url(https://d3p0bla3numw14.cloudfront.net/news-content/img/2021/02/05102610/1-fasilitas-kantor-sewa.jpg);
...
<div class="container">
	<div class="col-lg-12"><br>
		<div class="row">
		<h3 class="text-white">absensi <?php echo $res['name']; ?></h3><br>
		<a href="viewhr.php?no=<?php echo $no; ?>" class="col-lg-3"><button class="btn btn-success col-lg-4" name="logout">back</button></a>
