...
<style>
body{
	background-image:linear-gradient(rgba(71,71,71,0.7),rgba(71,71,71,0.7)),url(https://jendela360.com/info/wp-content/uploads/2020/09/interior-kantor-modern.jpg);
...
?>
			...
			<tr class="text-white">
				...
				<th><a  href="update.php?no=<?php echo $res['no']; ?>" class="text-white"><button class="btn btn-success">View</button></a></th>
			</tr>
<?php }
?>
